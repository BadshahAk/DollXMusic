...
from DOLL import app
from pyrogram.types import InputMediaVideo
from DOLL.misc import SUDOERS
from DOLL.utils.database import add_sudo, remove_sudo
from DOLL.utils.decorators.language import language
from DOLL.utils.extraction import extract_user
from DOLL.utils.inline import close_markup
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_video(video="https://graph.org/file/338ad108e9f004d2f4eab-fe4c1e83d67acb5705.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("Anand ᴋᴀ 𝗟ᴜɴᴅ 𝗟ᴇɢᴀ 😂 \n 𝗦ᴜᴅᴏʟɪsᴛ 𝗗ᴇᴋʜɴᴇ ᴀᴀʏᴀ ᴍᴄ 🤧🖕", show_alert=True)
    else:
